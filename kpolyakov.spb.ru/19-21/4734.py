def move(a, b):
    return (a, b + 2), (a, b * 3), (a + 2, b), (a * 3, b)


size = 100
s = [[0] * 1000 for _ in range(1000)]
win = 47  # количество камней для победы (включительно)
lose = 59 + 1  # количество камней для поражения
first = 5  # количество камней в первой куче
